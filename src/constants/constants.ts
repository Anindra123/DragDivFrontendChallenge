...
export const SMALL_BOX_HEIGHT = 100;
export const SMALL_BOX_WIDTH = 100;
export const INITIAL_BOX_POSITION = {
  x: 250,
  y: 250,
};

export const INITIAL_PARENT_POSITION = {
  x: 450,
  y: 100,
};

export const INITIAL_PARENT_SIZE = {
  width: 600,
  height: 600,
};
